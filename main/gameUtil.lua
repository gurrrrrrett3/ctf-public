...
---Open/close a corporation door.
---@param corpIndex integer
---@param state boolean
function setCorpDoorState(corpIndex, state)
	local event = events.createSound(1, Vector())
	event.type = 10
	event.a = corpIndex
	event.b = state and 1 or 0

	corporations[corpIndex].isDoorOpen = state and 1 or 0
end
